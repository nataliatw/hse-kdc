...
import { hazardsData } from '../../data/hazarddata';
...
function Hazards() {
      ...
      const setFilteredData = useHazardStore((state) => state.setFilteredData);
      const filteredData = useHazardStore((state) => state.filteredData);
      const setFilteredDownloadData = useHazardStore((state) => state.setFilteredDownloadData)
      ...
      useEffect(() => {
        ...
        const processData = () => {
          if (startDate && endDate) {
            ...
            const rangeData = hazardsData.date.filter(d => {
            ...
            const filteredDates = hazardsData.date.filter(date =>
      ...
      }, [startDate, endDate, selectedSite, selectedCompany, hazardsData]);     

      const calculateTotalHazards = () => {
        let total = 0;

        hazardsData?.date?.forEach(date => {
      ...
      const calculateFilteredTotal = () => {
        ...
        hazardsData?.date?.forEach(dateItem => {
      ...
      const totalAllHazards = isFilterActive
        ? calculateFilteredTotal()
        : calculateTotalHazards();

  return (
    <div className="p-6 min-h-screen">
      {/* Baris 1: Judul + Filter */}
      <div className="flex justify-between items-center mb-6 flex-wrap gap-3">
        <h1 className="font-bold text-4xl text-gray-800">Hazards</h1>
      ...
      <div className="flex flex-wrap gap-4 justify-start items-center mb-6">
        ...
        <div className="bg-red-50 border border-red-200 px-6 py-4 shadow-md rounded-2xl flex items-center gap-3 min-w-[180px] ml-auto">
          <img src="src/assets/icons/shield-exclamation.svg" alt="Total Hazard" className="w-6 h-6" />
          <div>
            <h3 className="text-sm font-medium text-gray-700">Total Hazard</h3>
            <p className="text-red-600 text-xl font-bold">{totalAllHazards}</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-5 rounded-2xl shadow-lg">
          <h2 className="text-lg font-semibold text-center mb-3 text-gray-800">Total Hazards by Site</h2>
          <VertikalBarChartComponent data={filteredData.filter((d) => d.type === "site")} />
        </div>

        <div className="bg-white p-5 rounded-2xl shadow-lg">
          <h2 className="text-lg font-semibold text-center mb-3 text-gray-800">Total Hazards by Company</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        <div className="bg-white p-5 rounded-2xl shadow-lg flex flex-col items-center">
          <h2 className="text-lg font-semibold mb-3 text-gray-800">Total Hazards by Department</h2>
        ...
        <div className="bg-white p-5 rounded-2xl shadow-lg flex flex-col items-center">
          <h2 className="text-lg font-semibold mb-3 text-gray-800">Total Hazards by Jabatan Pelapor</h2>
          <div className="w-full max-w-[600px]">
      ...
      <div className="bg-white p-5 rounded-2xl shadow-lg mt-6">
        <h2 className="text-lg font-semibold text-center mb-3 text-gray-800">Total Hazard by Location</h2>
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="border border-gray-300 px-4 py-2 text-center">Jumlah Hazard</th>
            </tr>
          </thead>
          <tbody>
